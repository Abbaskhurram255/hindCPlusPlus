...
float joro(float a, float b)
{
    return a + b;
}
float nikalo(float a, float b)
{
    return a - b;
}
float zarb(float a, float b)
{
    return a * b;
}
float baato(float a, float b)
{
    return a / b;
}
...
int isdivisor(float of, float n)
{
    return mod(of, n) == 0;
}
int iseven(int n)

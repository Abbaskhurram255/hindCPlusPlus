...
class TKCalendar(ttk.Frame):
    ...
    def _pressed(self, evt):
        ...
        try:
            self._TargetElement.Change(self.datetime(year, month, int(self._selection[0]), now.hour, now.minute, now.second).strftime(self.format))
    ...
    def _next_month(self):
        """Change calendar to show the next month."""
        self._canvas.place_forget()

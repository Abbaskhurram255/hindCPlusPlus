...
from hindGui import EVENT_SYSTEM_TRAY_ICON_ACTIVATED  # = '__ACTIVATED__'
from hindGui import EVENT_SYSTEM_TRAY_ICON_DOUBLE_CLICKED  # = '__DOUBLE_CLICKED__'
from hindGui import EVENT_SYSTEM_TRAY_MESSAGE_CLICKED  # = '__MESSAGE_CLICKED__'
from hindGui import SYSTEM_TRAY_MESSAGE_DISPLAY_DURATION_IN_MILLISECONDS  # = 3000  # how long to display the window
from hindGui import SYSTEM_TRAY_MESSAGE_FADE_IN_DURATION  # = 1000  # how long to fade in / fade out the window
from hindGui import SYSTEM_TRAY_MESSAGE_MAX_LINE_LENGTH  # = 50
from hindGui import SYSTEM_TRAY_MESSAGE_TEXT_COLOR  # = '#ffffff'
from hindGui import SYSTEM_TRAY_MESSAGE_WIN_COLOR  # = '#282828'
from hindGui import SYSTEM_TRAY_WIN_MARGINS  # = 160, 60  # from right edge of screen, from bottom of screen
from hindGui import TEXT_LOCATION_TOP_LEFT
from hindGui import TIMEOUT_KEY
from hindGui.elements.graph import Graph
from hindGui.elements.helpers import AddMenuItem
from hindGui.elements.image import Image
...
from hindGui import SYSTEM_TRAY_MESSAGE_ICON_INFORMATION
from hindGui import SYSTEM_TRAY_MESSAGE_ICON_WARNING
from hindGui import SYSTEM_TRAY_MESSAGE_ICON_CRITICAL
from hindGui import SYSTEM_TRAY_MESSAGE_ICON_NOICON

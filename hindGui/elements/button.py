...
import hindGui
from hindGui import BROWSE_FILES_DELIMITER
from hindGui import BUTTON_DISABLED_MEANS_IGNORE
from hindGui import BUTTON_TYPE_BROWSE_FILE
from hindGui import BUTTON_TYPE_BROWSE_FILES
from hindGui import BUTTON_TYPE_BROWSE_FOLDER
from hindGui import BUTTON_TYPE_CALENDAR_CHOOSER
from hindGui import BUTTON_TYPE_CLOSES_WIN
from hindGui import BUTTON_TYPE_CLOSES_WIN_ONLY
from hindGui import BUTTON_TYPE_COLOR_CHOOSER
from hindGui import BUTTON_TYPE_READ_FORM
from hindGui import BUTTON_TYPE_SAVEAS_FILE
from hindGui import COLOR_SYSTEM_DEFAULT
from hindGui import ELEM_TYPE_BUTTON
from hindGui import ELEM_TYPE_BUTTONMENU
from hindGui import FILE_TYPES_ALL_FILES
from hindGui import MENU_SHORTCUT_CHARACTER
...
class Button(Element):
    ...
    def ButtonCallBack(self):
        ...
        if should_submit_window:
            self.ParentForm.LastButtonClicked = target_element.Event
            self.ParentForm.FormRemainedOpen = True
            _exit_mainloop(self.ParentForm)
    ...
    def change(
        ...
        if self.UseTtkButtons:
            ...
            # style_name = str(self.Event) + 'custombutton.TButton'
...
from hindGui._utils import _error_popup_with_traceback, _exit_mainloop

...
import hindGui
from hindGui import _change_ttk_theme
...
class TKProgressBar:
    ...
    def __init__(
        ...
        max,
        length=400,
        width=hindGui.DEFAULT_PROGRESS_BAR_SIZE[1],
        ttk_theme=hindGui.DEFAULT_TTK_THEME,
        style_name='',
        relief=hindGui.DEFAULT_PROGRESS_BAR_RELIEF,
...
class ProgressBar(Element):
    ...
    def __init__(
        ...
        self.Orientation = orientation if orientation else hindGui.DEFAULT_METER_ORIENTATION
        ...
        if bar_color is None:
            bar_color = hindGui.DEFAULT_PROGRESS_BAR_COLOR
        else:
        ...
        self.BarStyle = style if style else hindGui.DEFAULT_TTK_THEME

...
from hindGui import ELEM_TYPE_SIZEGRIP
...
class Sizegrip(Element):
    ...
    def __init__(self, background_color=None, pad=None, p=(0, 0), action=None, k=None):
        """
        Sizegrip Element
        ...
        super().__init__(ELEM_TYPE_SIZEGRIP, background_color=bg, action=action, pad=pad)

...
def _error_popup_with_traceback(title, *args, emoji=None):
    if hindGui.SUPPRESS_ERROR_POPUPS:
        return
    trace_details = traceback.format_stack()
    error_message = ''
...
from hindGui import execute_editor
from hindGui import execute_get_editor
from hindGui import popup_quick_message
from hindGui import WIN_CLOSED
from hindGui.elements.button import Button
